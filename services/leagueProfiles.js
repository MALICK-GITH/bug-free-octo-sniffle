...
const LEAGUE_PROFILES = [
  ...
  },
  {
    ...
    goalBias: 0,
    exactScoreAllowed: true,
    exactScoreWeight: 0.7,
    reliabilityBoost: -5,
    recommendedMarkets: ["score exact", "victoire"],
    avoidMarkets: ["over 3.5", "martingale"],
    note: "Scores exacts maintenant supportés avec algorithme amélioré pour penalty.",
  },
];
